...
function generateWordCloudNegatives(business_id) {
    ...
    Highcharts.theme_negatives = {
        colors: ['#003d52', '#005c7b', '#007aa4', '#0098cd', '#17afe3', '#45bfe9',
            '#5cc7eb', '#8bd7f1', '#b9e7f6', '#d0eff9', '#e7fcfc'
        ],
        chart: {
            backgroundColor: {
                linearGradient: {
