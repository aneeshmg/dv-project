function initMap(){
            ...
            ['address_components', 'geometry', 'icon', 'name']);
              ...
              google.maps.event.addListener(autocomplete, 'place_changed', function() {
              	...
              	var locations = [
			      [33.390542, -111.974856],
			      [33.423036, -111.959052],
			      [33.328249, -111.957507],
			      [33.300513, -111.887478],
			      [33.350198, -111.959302]
			    ];
			    ...
			    for (i = 0; i < locations.length; i++) {  
			      ...
			      d3.csv("data/businesses.csv", function(rows) {
					  console.log(rows);
					});
...
/*			      google.maps.event.addListener(marker, 'click', (function(marker, i) {
              	...
              	/*var myLatlng = new google.maps.LatLng(33.393,-111.944);
